...
namespace Ranosys\Quickview\Plugin;

class ProductList
{
    const XML_PATH_QUICKVIEW_ENABLED = 'ranosys_quickview/general/enable_product_listing';
...
//            $buttonStyle =  'weltpixel_quickview_button_' . $this->scopeConfig->getValue(self::XML_PATH_QUICKVIEW_BUTTONSTYLE,  \Magento\Store\Model\ScopeInterface::SCOPE_STORE);
            ...
            return $result . '<a data-quickview-url=' . $productUrl . ' href="javascript:void(0);"><span>' . __("Quickview") . '</span></a>';
        }
